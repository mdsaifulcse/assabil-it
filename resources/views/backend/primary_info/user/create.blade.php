                    ...
                    <div class=" row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @if(count($roles)>1)
                                {{Form::select('role_id',$roles,'',['class'=>'form-control select','required','readonly'=>true,'placeholder'=>'-Select Role-'])}}
                                @else
                                    {{Form::select('role_id',$roles,'',['class'=>'form-control select','required','readonly'=>false])}}
